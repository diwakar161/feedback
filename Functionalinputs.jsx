  ...
  return (
    ...
    <div className='inputfeed'>
      <form onSubmit={handlesubmit}>
       ...
       <input className='box1' type="text" name="name" onChange={handlename} value={name} >
       </input>
       <br/>
      ...
      <sup className='star'> *</sup> Your E-Mail ID:</label><br></br>
       <input className='box1' type="text" name="email" onChange={handlemail} value={email} >
       </input><br/>
